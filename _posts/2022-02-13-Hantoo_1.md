...
[![다운로드]({{ site.url }}{{ site.baseurl }}/assets/img/download_icon.png){: width="100" height="100"}](https://github.com/cocoslime/HantooSample/tree/master/files/libs.zip)
...
```
* 완벽하게 구현했음에도, LBS 서버 연결만 성공하고 서버 재접속을 계속 시도하다가 연결이 되지 않고 종료되는 현상이 나타나면, 앱을 완전히 삭제 후 다시 Run 해보시길 바랍니다.
```
