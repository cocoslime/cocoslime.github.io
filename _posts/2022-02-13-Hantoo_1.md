---
title:  "[한국투자증권 API] 1. 프로젝트 생성 및 설정 (feat. 안드로이드 런타임 권한 요청)"
excerpt: ""
...
한국투자증권 API (CommExpert)를 사용하여 안드로이드 어플리케이션을 만드는 과정을 설명합니다. 대상자는 안드로이드 앱 개발을 해보지 않으셨더라도 어느정도 Kotlin 언어를 이해할 수 있는 분을 대상으로 합니다.
...
![]({{ site.url }}{{ site.baseurl }}/assets/img/2022-02-13-Hantoo_1/project_create.png)
...
라이브러리 파일은 아래의 압축파일을 다운로드합니다. 라이브러리 빌드 및 자세한 내용은 추후에 따로 포스팅 하도록 하겠습니다.

https://github.com/cocoslime/HantooSample/tree/master/app/libs

# 라이브러리 import
다운 받은 총 3개의 파일 전부를 프로젝트 폴더의 “app/libs”에 복사합니다. 복사를 위해서 Android View를 Project View 로 변경하여 줍니다.

![Project View 선택]({{ site.url }}{{ site.baseurl }}/assets/img/2022-02-13-Hantoo_1/project_view.png)
...
![]({{ site.url }}{{ site.baseurl }}/assets/img/2022-02-13-Hantoo_1/gradle_sync.png)
...
![]({{ site.url }}{{ site.baseurl }}/assets/img/2022-02-13-Hantoo_1/android_permission.jpeg)


라이브러리 초기화에 성공하였을 경우, 서버 접속 성공 토스트 메시지를 확인할 수 있습니다.

![]({{ site.url }}{{ site.baseurl }}/assets/img/2022-02-13-Hantoo_1/android_toast.jpeg)


안드로이드 로그캣을 통해 초기화 과정 및 결과를 확인합니다.

![]({{ site.url }}{{ site.baseurl }}/assets/img/2022-02-13-Hantoo_1/logcat.png)

다음은 로그인 및 현재가 조회 기능 구현에 대해 포스팅 할 예정입니다. 본 포스팅도 꾸준히 업데이트 하도록 하겠습니다.
